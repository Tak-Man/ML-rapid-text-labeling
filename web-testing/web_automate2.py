    ...
    for r in range(reps):
        for k, v in phrases.items():
            ...
            if label_type == 'single':
                select_label_one_text('//*[@id="allTextsTable"]/tbody/tr[' + str(r + 1) + ']/td[1]', v,
                                      wait_time=wait_time)
...
def get_tracker_row(vectorizer_needs_transform, fully_human_labeled=True):
    try:
